...
public class LogMaskingConverter {
    private static final String CREDIT_CARD_REGEX = "([0-9]{10})";;
    private static final Pattern CREDIT_CARD_PATTERN = Pattern.compile(CREDIT_CARD_REGEX);
    private static final String CAREDIT_CARD_REPLACEMENT_REGEX = "XXXXXXXXXX";

    private static final String EMAIL_REGEX = "[a-zA-Z0-9_!#$%&'*+/=?`{|}~^.-]+@[a-zA-Z0-9.-]+";
    private static final Pattern EMAIL_PATTERN = Pattern.compile(EMAIL_REGEX);
    private static final String EMAIL_REPLACEMENT_REGEX = "#######";

    private static final String SSN_REGEX = "(currency=)[^&amp;]*";
    private static final Pattern SSN_PATTERN = Pattern.compile(SSN_REGEX);
    private static final String SSN_REPLACEMENT_REGEX = "$1XXXX";
...
//    @Override
    ...
    public static String mask(String message) {
        ...
        maskMatcher(matcher, buffer,EMAIL_REPLACEMENT_REGEX);
        message=buffer.toString();
        buffer.setLength(0);
    ...
    public static StringBuffer maskMatcher(Matcher matcher, StringBuffer buffer, String maskStr)
    {
        while (matcher.find()) {
